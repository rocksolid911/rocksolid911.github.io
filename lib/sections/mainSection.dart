...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: _themeProv.lightTheme ? Colors.white : Color(0xFF2A363B),
  ...
  Widget _appBarTabDesktop(ThemeProvider _themeProv) {
    return AppBar(
      elevation: 0.0,
      backgroundColor: _themeProv.lightTheme ? Colors.white : Color(0xFF1E5128),
  ...
  Widget _appBarMobile(ThemeProvider theme) {
    return Drawer(
      child: Material(
        color: theme.lightTheme ? Colors.white : k2ndColor,
        child: Padding(
