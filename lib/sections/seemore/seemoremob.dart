...
class SeeMoreMob extends StatefulWidget {
  const SeeMoreMob({Key key}) : super(key: key);

  @override
  _SeeMoreMobState createState() => _SeeMoreMobState();
}

class _SeeMoreMobState extends State<SeeMoreMob> {
  @override
...
class ListViewBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("More Projects"),
        backgroundColor:_themeProvider.lightTheme?k1Color: k2ndColor,
      ),
            ...
            return Padding(
              ...
              child: FlipCard(
                ...
                back: Container(
                  ...
                  height: width < 1200 ? height * 0.4 : height * 0.6,
