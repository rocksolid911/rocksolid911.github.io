...
class _GetInTouchDesktopState extends State<GetInTouchDesktop> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        backgroundColor:
            _themeProvider.lightTheme ? Colors.white :  Color(0xFF2A363B),
        body: Stack(
          children: [
            Padding(
              padding:
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: OutlinedCustomBtn(
                                    ...
                                    onPressed: () {
                                      launchURL(
                                          "mailto:siddhantsaraf.91@gmail.com?subject=SOMESUBJECT&body=are you up for a project with database:$_database budget:$_estBudget projecttype: $_projectType duration: ${_projectDuration.toString()} msg: ${_msgController.toString()}");
                                    },
                                  ),
                                )
                              ],
