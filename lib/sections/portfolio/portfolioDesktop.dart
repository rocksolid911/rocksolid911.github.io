...
import 'package:portfolio/sections/seemore/seemore.dart';
...
class PortfolioDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      //color: _themeProvider.lightTheme ? Colors.white : Color(0xFF4E9F3D),
      ...
      child: Column(
        children: [
          ...
          OutlinedCustomBtn(
              btnText: "See More",
              onPressed: () {
               // launchURL("https://github.com/rocksolid911");
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => SeeMore(),
